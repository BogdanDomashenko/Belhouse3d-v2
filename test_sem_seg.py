...
def test_dataset(args):
  if args.dataset == 'touchstone3d':
    ...
    testSet = Touchstone3DDataset(map_file='/data/leuven/374/vsc37447/data/belhouse3d/processed/meta/map.pkl', 
                                   npts=2048, mode='test', 
                                   data_path='/data/leuven/374/vsc37447/data/belhouse3d/processed/test/blocks', 
