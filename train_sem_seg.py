...
def dataset(args):
  if args.dataset == 'touchstone3d': # dataset with sampling
    ...
    trainSet = Touchstone3DDataset(map_file='/data/leuven/374/vsc37447/data/belhouse3d/processed/meta/map.pkl', 
                                   npts=2048, mode='train', 
                                   data_path='/data/leuven/374/vsc37447/data/belhouse3d/processed/train/blocks', 
                                   pc_attribs='xyz', pc_augm=True, pc_augm_config=pc_augm_config)
    valSet = Touchstone3DDataset(map_file='/data/leuven/374/vsc37447/data/belhouse3d/processed/meta/map.pkl', 
                                 npts=2048, mode='test', 
                                 data_path='/data/leuven/374/vsc37447/data/belhouse3d/processed/val/blocks', 
                                 pc_attribs='xyz')
...
def train(args, train_dataset, valid_dataset, classes, weights=None, logdir=None):
  ...
  for epoch in range(0, args.epoch):
    ...
    for i in range(len(iou_perclass)):
      LOG.info(f'{i+1}/{len(iou_perclass)}')
